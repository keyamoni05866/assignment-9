...
const Job = ({job}) => {
    const {title,company_name,location,Image,salary,job_type1,job_type2} = job
    ...
    return (
       ...
       <button className=' px-3 py-1 span1 me-2 mb-3'><span className='span'>{job_type1}</span></button>
       <button className=' px-4 py-1 span1 ms-2'><span className='span'>{job_type2}</span></button>
       <div className='flex '>
       <div className=''>
